...
//        setMainPanelSize();
    ...
    {
        JTabbedPane coordinacionTabbedPane = new JTabbedPane(JTabbedPane.LEFT);
        JPanel coordinacionPanel = new JPanel();
    ...
    {
        JTabbedPane subAcadTabbedPane = new JTabbedPane(JTabbedPane.LEFT);
    ...
    {
        JTabbedPane coordLabTabbedPane = new JTabbedPane(JTabbedPane.LEFT);
